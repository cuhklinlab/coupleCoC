...
% load the data 
load('data/example2_T.mat');
load('data/example2_T_label.mat');
load('data/example2_S.mat');
load('data/example2_S_label.mat');
...
%coupleCoCp
%[Cx1, Cy1, Cz1, cluster_p1, cluster_q1, obj1] = coupleCoCp(X,Y,2,2,5,15,2,0.01,1);
